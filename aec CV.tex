...
\includegraphics[width=2cm,clip]{aec_logo.png}
...
\begin{tabularx}{\linewidth}{L r}
  ...
  {Assam Engineering College, Guwahati} &  \href{https://github.com/\github}{Github} $|$ \href{\website}{Website}\\
...
%       {Bachelor of Technology in Electronics and Telecommunication;  GPA: 8.10}{July. 202X -- July. 202X (Expected)}
%     \resumeSubheading
%       {Model School}{Guwahati, Assam}
...
{\dimexpr\textwidth-3mm\relax}{|c|C|c|c|}
  ...
  \hline
  B.E.  & Assam Engineering College Guwahati & 0.0r0 (Current) & 2020-Present\\
  \hline
  Senior Secondary & CBSE Board & 00.0\% & 2020 \\
  \hline
  Secondary & CBSE Board & 00.0\% & 2018 \\
  \hline
\end{tabularx}}
\vspace{-2mm}
...
\resumePOR{Bronze Medal} % Award
    { XYZ Challenge, ABC Company, Guwahati} % Event
    {2023} %Event Year
\resumePOR{SIH} % Award
